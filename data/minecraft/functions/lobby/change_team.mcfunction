...
# enter team
execute at @e[tag=system_lobby_mark_join_red] run tag @e[tag=!sheep_team_red,scores={s_blow_time=1},distance=..4,limit=1] add system_join_red_temp
execute at @e[tag=system_lobby_mark_join_blue] run tag @e[tag=!sheep_team_blue,scores={s_blow_time=1},distance=..4,limit=1] add system_join_blue_temp
