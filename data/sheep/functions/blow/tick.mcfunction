...
# speical sheep fast
execute as @e[tag=sheep_type_fast,scores={s_flying_time=20..,s_blow_time=0}] at @s at @a[distance=..8] positioned ~ ~1 ~ if entity @s[distance=..3] run scoreboard players set @s s_blow_time 1
# no explode
