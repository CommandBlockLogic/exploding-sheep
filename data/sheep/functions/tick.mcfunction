...
execute as @a[scores={s_launch=1..,s_energy=60..,s_launch_type=4},nbt={SelectedItemSlot:0}] at @s anchored eyes run function sheep:launch/main
scoreboard players remove @a[scores={s_launch=1..,s_energy=60..,s_launch_type=4},nbt={SelectedItemSlot:0}] s_energy 60
...
scoreboard players remove @a[scores={s_launch=1..,s_energy=80..,s_launch_type=5},nbt={SelectedItemSlot:0}] s_energy 80
