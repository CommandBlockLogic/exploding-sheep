...
summon minecraft:area_effect_cloud -176.5 10.0 -124.5 {Duration:9999999,Tags:["system_lobby_mark","system_mode_mark","system_mode_change_mark","system_mode_change_mark_single"],CustomName:"[\"切换 \",{\"text\":\"个人\",\"color\":\"yellow\"},\"/\",{\"text\":\"队伍\",\"color\":\"white\"}]"}
