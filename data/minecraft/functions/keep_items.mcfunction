...
execute as @a[scores={s_class=104},nbt=!{Inventory:[{Slot:8b,tag:{item_num:3,wool_type:104}}]}] run function sheep:item/wools
execute as @a[scores={s_launch_type=1},nbt=!{Inventory:[{Slot:-106b,tag:{item_num:4,wool_type:1}}]}] run function sheep:item/wools
execute as @a[scores={s_launch_type=2},nbt=!{Inventory:[{Slot:-106b,tag:{item_num:4,wool_type:2}}]}] run function sheep:item/wools
execute as @a[scores={s_launch_type=3},nbt=!{Inventory:[{Slot:-106b,tag:{item_num:4,wool_type:3}}]}] run function sheep:item/wools
...
execute as @a[scores={s_launch_type=104},nbt=!{Inventory:[{Slot:-106b,tag:{item_num:4,wool_type:104}}]}] run function sheep:item/wools