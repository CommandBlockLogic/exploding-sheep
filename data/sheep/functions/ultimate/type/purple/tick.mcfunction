...
execute as @e[tag=sheep_temp,tag=sheep_ulti_purple_mark] at @s rotated ~16 ~ run tp @s ~ ~ ~ ~ ~
...
execute as @e[tag=sheep_temp,tag=sheep_ulti_purple_s] at @s run tag @e[tag=boss_normal,distance=..1] add ms_harmed
