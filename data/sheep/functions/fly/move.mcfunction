...
execute if entity @s[tag=sheep_touch_block_temp] scoreboard players operation @s s_temp5 -= @s s_temp2
...
execute if entity @s[tag=sheep_touch_block_temp] scoreboard players operation @s s_temp5 -= @s s_temp3
...
execute if entity @s[tag=sheep_touch_block_temp] scoreboard players operation @s s_temp5 -= @s s_temp4
