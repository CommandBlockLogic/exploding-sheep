...
execute if entity @a[tag=player_join_red] run tellraw @a [">> ",{"selector":"@a[tag=player_join_red]"},"加入了战斗§r"]
execute if entity @a[tag=player_join_blue] run tellraw @a [">> ",{"selector":"@a[tag=player_join_blue]"},"加入了战斗§r"]
