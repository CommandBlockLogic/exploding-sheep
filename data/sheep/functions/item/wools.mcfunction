...
replaceitem entity @s[scores={s_class=3}] hotbar.8 minecraft:blue_wool{item_num:3,wool_type:3,display:{Name:"[{\"text\":\"你拥有了 \",\"color\":\"white\",\"italic\":false},{\"text\":\"小蓝羊\",\"color\":\"blue\"}]"}}
...
replaceitem entity @s[scores={s_launch_type=3}] weapon.offhand minecraft:blue_wool{item_num:4,wool_type:3}
