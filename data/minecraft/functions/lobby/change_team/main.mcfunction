...
execute if score game_mode_status system matches 0 run function lobby/change_team/group
execute if score game_mode_status system matches 1 run function lobby/change_team/single