...
# lime
execute as @e[tag=sheep_type_lime,tag=sheep_team_red,scores={s_blow_time=1..}] at @s run effect give @a[team=red,distance=..5] minecraft:regeneration 3 2 true
execute as @e[tag=sheep_type_lime,tag=sheep_team_blue,scores={s_blow_time=1..}] at @s run effect give @a[team=blue,distance=..5] minecraft:regeneration 3 2 true
