...
execute as @a[scores={s_launch=1..,s_energy=50..},nbt={SelectedItemSlot:1}] at @s anchored eyes positioned ^ ^ ^ run function sheep:fan/main
execute as @a[scores={s_launch=1..,s_energy=50..},nbt={SelectedItemSlot:1}] run scoreboard players remove @s s_energy 50
