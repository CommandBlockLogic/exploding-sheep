...
/summon minecraft:falling_block -161 9 -126 {Time:1,NoGravity:1,Glowing:1,BlockState:{Name:smooth_stone},Tags:["system_lobby_mark","system_lobby_mark_enter_block"]}
