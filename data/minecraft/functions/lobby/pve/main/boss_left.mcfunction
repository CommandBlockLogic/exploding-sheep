...
tellraw @s[tag=defeat_boss_3,tag=defeat_boss_2,tag=!defeat_boss_1] [{"text":"## 你感觉到某个邪恶的东西正盯着你看 ","color":"gray","italic":"true"},{"text":"(2/3)","bold":"true","color":"gray","italic":"true"}]

tellraw @s[tag=defeat_boss_3,tag=defeat_boss_2,tag=defeat_boss_1] [{"text":"## 你击杀了墓园内所有的boss. 远处的羊羊山传来了巨响, 你决定前往一探究竟 ","color":"gray","italic":"true"},{"text":"(3/3)","bold":"true","color":"gray","italic":"true"}]
tellraw @s[tag=defeat_boss_3,tag=defeat_boss_2,tag=defeat_boss_1] [{"text":"## 注意！ 羊羊山脚下有隐藏的机关","color":"gray","italic":"true"}]
