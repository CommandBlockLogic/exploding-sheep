...
execute as @e[scores={s_web_time=1..},tag=sheep_web_mark_red] at @s run effect give @a[distance=..2,team=blue] minecraft:slowness 1 2 false
execute as @e[scores={s_web_time=1..},tag=sheep_web_mark_blue] at @s run effect give @a[distance=..2,team=red] minecraft:slowness 1 2 false
