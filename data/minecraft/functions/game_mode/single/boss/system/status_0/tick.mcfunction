...
execute if score Boss复活冷却 boss_4_system matches 40 run title @a clear
...
execute if score Boss复活冷却 boss_4_system matches 5 run effect give @a minecraft:instant_health 1 10 true
