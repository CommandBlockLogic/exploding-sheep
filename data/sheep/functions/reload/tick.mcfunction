...
# heal
effect give @a[scores={s_class=2..,s_energy=160..}] minecraft:regeneration 1 0 true
effect give @a[scores={s_class=1,s_energy=240..}] minecraft:regeneration 1 0 true
