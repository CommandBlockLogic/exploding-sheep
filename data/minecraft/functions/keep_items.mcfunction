...
execute unless score game_status system matches 0 unless score game_status system matches 105 as @a[nbt={Inventory:[{Slot:7b}]}] run replaceitem entity @s hotbar.7 minecraft:air
