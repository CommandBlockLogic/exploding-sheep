...
advancement grant @s[scores={s_launch_type=1001},advancements={sheep:sheep/volleyball=false}] only sheep:sheep/volleyball
advancement grant @s[scores={s_launch_type=1002},advancements={sheep:sheep/football=false}] only sheep:sheep/football
