...
# change color
execute if score game_mode_status system matches 0 as @e[tag=system_mode_change_mark_single] run data merge entity @s {CustomName:"[\"切换 \",{\"text\":\"个人\",\"bold\":\"false\"},\"/\",{\"text\":\"队伍\",\"bold\":\"true\"}]"}
...
execute if score game_mode_status system matches 1 as @e[tag=system_mode_change_mark_group] run data merge entity @s {CustomName:"[\"切换 \",{\"text\":\"个人\",\"bold\":\"true\"},\"/\",{\"text\":\"队伍\",\"bold\":\"false\"}]"}
