...
# change_color
data merge entity @s[scores={s_ulti_sheep=1}] {Color:1}
data merge entity @s[scores={s_ulti_sheep=4}] {Color:2}
...
execute as @a if score @s s_id = @e[tag=sheep_temp,limit=1] s_thrower_id at @s anchored eyes run tp @e[tag=sheep_temp,limit=1] ^ ^0.5 ^1
