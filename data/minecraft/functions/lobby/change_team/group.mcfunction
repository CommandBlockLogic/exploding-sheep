...
# enter team
execute at @e[tag=system_lobby_mark_join_red] run tag @e[tag=!sheep_team_red,scores={s_blow_time=2},distance=..3,limit=1] add system_join_red_temp
execute at @e[tag=system_lobby_mark_join_blue] run tag @e[tag=!sheep_team_blue,scores={s_blow_time=2},distance=..3,limit=1] add system_join_blue_temp
execute at @e[tag=system_lobby_mark_join_gray] run tag @e[tag=sheep_team_blue,scores={s_blow_time=2},distance=..3,limit=1] add system_join_gray_temp
execute at @e[tag=system_lobby_mark_join_gray] run tag @e[tag=sheep_team_red,scores={s_blow_time=2},distance=..3,limit=1] add system_join_gray_temp
