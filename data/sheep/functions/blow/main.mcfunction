...
execute if entity @s[tag=sheep_type_heal,tag=!sheep_team_blue,tag=!sheep_team_red] as @a if score @s s_id = @e[tag=sheep_temp,limit=1] s_thrower_id run tag @s add heal_me
