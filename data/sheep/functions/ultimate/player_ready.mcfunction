...
execute if entity @e[tag=sheep_thatsit,tag=sheep_random_4] run scoreboard players set @s s_class 104
...
tellraw @s[scores={s_class=103}] [">> 啊！是超级",{"text":"橙羊羊","color":"gold"},"! 橙羊羊落地后会自动发射羊羊攻击对手!"]
tellraw @s[scores={s_class=104}] [">> 啊！是超级",{"text":"绿羊羊","color":"gray"},"! 落地后会为附近队友回复生命!"]