...
replaceitem entity @s[scores={s_class=103}] hotbar.8 minecraft:orange_wool{item_num:3,wool_type:103,display:{Name:"[{\"text\":\"你拥有了 \",\"color\":\"white\",\"italic\":false},{\"text\":\"超橙羊\",\"color\":\"gold\"}]"}}
replaceitem entity @s[scores={s_class=104}] hotbar.8 minecraft:lime_wool{item_num:3,wool_type:104,display:{Name:"[{\"text\":\"你拥有了 \",\"color\":\"white\",\"italic\":false},{\"text\":\"超绿羊\",\"color\":\"green\"}]"}}
...
replaceitem entity @s[scores={s_launch_type=103}] weapon.offhand minecraft:orange_wool{item_num:4,wool_type:103}
replaceitem entity @s[scores={s_launch_type=104}] weapon.offhand minecraft:lime_wool{item_num:4,wool_type:104}