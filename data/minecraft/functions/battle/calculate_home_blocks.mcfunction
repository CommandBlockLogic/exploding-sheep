...
execute as @e[type=falling_block] run scoreboard players add system_red_score system 1
...
execute as @e[type=falling_block] run scoreboard players add system_blue_score system 1
