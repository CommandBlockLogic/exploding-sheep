...
# 选类型提示
summon minecraft:area_effect_cloud -161 9 -129 {Duration:9999999,Tags:["system_lobby_mark","system_class_mark","system_class_mark_orange"],CustomName:"[\"§6吸收§r\"]",Passengers:[{id:"item",Age:-32768,PickupDelay:32767,Invulnerable:1,Tag:["system_protect_item"],Item:{id:"minecraft:golden_chestplate",Count:1}}]}
