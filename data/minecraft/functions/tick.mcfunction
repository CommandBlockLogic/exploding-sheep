...
# hint show
execute as @e[tag=system_class_mark,nbt={CustomNameVisible:0}] at @s if entity @a[distance=..3] run data merge entity @s {CustomNameVisible:1}
execute as @e[tag=system_class_mark,nbt={CustomNameVisible:1}] at @s unless entity @a[distance=..3] run data merge entity @s {CustomNameVisible:0}
