...
playsound minecraft:entity.ender_dragon.growl ambient @a[team=!blue] 0 10 0 1 1 0.5
playsound minecraft:entity.player.levelup ambient @a[team=blue] 0 10 0 1 0.5 0.5
