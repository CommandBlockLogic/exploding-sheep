...
execute if entity @e[tag=sheep_thatsit,tag=sheep_random_3] run scoreboard players set @s s_class 103
...
execute if score @s s_class matches 103 as @e[tag=sheep_ulti] if score @s s_thrower_id = @a[tag=player_temp,limit=1] s_id run data merge entity @s {Color:5}
execute if score @s s_class matches 202 as @e[tag=sheep_ulti] if score @s s_thrower_id = @a[tag=player_temp,limit=1] s_id run data merge entity @s {Color:1}
