# game_mode/select_mode/check_players_single
...
# set score
execute if score game_status system matches 0 if score system_flag system matches 0 run function gamemode/select_mode/reset_confirm_timer
