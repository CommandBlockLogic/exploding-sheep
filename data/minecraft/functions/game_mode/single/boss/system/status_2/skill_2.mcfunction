...
# 白
execute as @e[tag=boss4] at @s function minecraft:game_mode/single/boss/system/status_1/passive
# 蓝
execute as @e[tag=boss4] at @s function minecraft:game_mode/single/boss/system/status_2/skill_2_launch
# 红
