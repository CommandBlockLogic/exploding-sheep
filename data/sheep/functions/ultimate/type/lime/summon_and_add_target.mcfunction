...
execute if entity @a[tag=player_target,limit=1] at @s run summon minecraft:sheep ^ ^ ^ {Tags:["sheep_sheep","sheep_type_lime","sheep_attr_no_gravity","sheep_new","sheep_new2"],Color:5,Silent:1,Age:-999999,Invulnerable:1,NoAI:1}
