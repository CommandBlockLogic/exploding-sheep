...
execute store result bossbar minecraft:boss_cool value run scoreboard players get Boss冷却百分比 boss_4_system
bossbar set minecraft:boss_cool name [{"text":"羊羊之神苏醒中...","color":"white"},{"text":" (","color":"white"},{"score":{"objective":"boss_4_system","name":"Boss冷却百分比"}},{"text":"%)","color":"white"}]
