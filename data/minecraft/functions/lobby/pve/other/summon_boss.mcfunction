...
# 召唤boss
execute if entity @e[tag=S_B_1,type=armor_stand,tag=selected_boss] run summon minecraft:skeleton -110 5 -80 {HandItems:[{id:"minecraft:bow",Count:1b,tag:{Enchantments:[{id:"minecraft:punch",lvl:3}]}},{id:"minecraft:blaze_rod",Count:1b,tag:{Enchantments:[{id:"minecraft:punch",lvl:3}]}}],ArmorItems:[{id:"minecraft:diamond_boots",Count:1,tag:{Enchantments:[{id:"minecraft:protection",lvl:1}]}},{id:"minecraft:diamond_leggings",Count:1,tag:{Enchantments:[{id:"minecraft:protection",lvl:1}]}},{id:"minecraft:diamond_chestplate",Count:1,tag:{Enchantments:[{id:"minecraft:protection",lvl:1}]}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:"HerobrineXia",Enchantments:[{id:"minecraft:protection",lvl:1}]}}],CustomName:"{\"text\":\"法师\",\"color\":\"gold\"}",CustomNameVisible:1b,Tags:["boss1","monster","boss_exist","kill_target"],Attributes:[{Base:100.0d,Name:"generic.maxHealth"},{Base:50.0d,Name:"generic.followRange"}],Health:100.0f,PersistenceRequired:1b,FallFlying:1b}
