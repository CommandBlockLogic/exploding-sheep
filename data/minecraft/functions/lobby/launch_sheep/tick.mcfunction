...
execute as @e[tag=system_fan_mark,scores={system_time=30..}] at @s if entity @a[x=-214,y=5,z=-204,dx=74,dy=60,dz=70,nbt=!{Health:0.0f}] run function lobby/launch_sheep/main
