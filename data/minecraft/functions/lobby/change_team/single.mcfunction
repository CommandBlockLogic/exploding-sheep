...
# enter team
execute at @e[tag=system_lobby_mark_join_yellow] run tag @e[tag=!sheep_team_yellow,scores={s_blow_time=1},distance=..3,limit=1] add system_join_yellow_temp
execute at @e[tag=system_lobby_mark_join_gray] run tag @e[tag=sheep_team_yellow,scores={s_blow_time=1},distance=..3,limit=1] add system_join_gray_temp
