...
scoreboard players operation spg_sheep_launcher_type system = @e[type=minecraft:sheep,tag=sheep_sheep,tag=!sheep_shot_by_launcher,x=-181.0,y=19.0,z=-167.0,dx=2.0,dy=1.0,dz=2.0,sort=nearest,limit=1] s_sheep_type
