...
execute as @e[tag=boss2] if score @s boss_2_pass >= 技能冷却 boss_2_pass at @s if entity @a[gamemode=adventure,distance=..16] run function minecraft:lobby/pve/boss_2/summon_sheep
