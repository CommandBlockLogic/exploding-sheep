...
execute as @e[tag=system_mode_mark,nbt=!{CustomNameVisible:1b}] at @s if entity @a[distance=..2] run data merge entity @s {CustomNameVisible:1}
execute as @e[tag=system_mode_mark,nbt={CustomNameVisible:1b}] at @s unless entity @a[distance=..2] run data merge entity @s {CustomNameVisible:0}
