...
execute if score game_mode_status system matches 0 run setblock -174 9 -126 minecraft:wall_sign[facing=south]{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function minecraft:lobby/change_mode\"}}",Text2:"{\"text\":\"\\u00a7l\\u00a7e单人\\u00a7r\"}",Text3:"{\"text\":\"\\u00a7l\\u00a77> \\u00a7c组\\u00a79队 \\u00a77<\\u00a7r\"}"} destroy
...
execute if score game_mode_status system matches 1 run setblock -174 9 -126 minecraft:wall_sign[facing=south]{Text1:"{\"text\":\"\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function minecraft:lobby/change_mode\"}}",Text2:"{\"text\":\"\\u00a7l\\u00a77> \\u00a7e单人 \\u00a77<\\u00a7r\"}",Text3:"{\"text\":\"\\u00a7l\\u00a7c组\\u00a79队\\u00a7r\"}"} destroy
