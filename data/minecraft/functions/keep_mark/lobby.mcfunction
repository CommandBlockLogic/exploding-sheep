...
# 进入游戏 选类型提示
summon minecraft:area_effect_cloud -164 10 -129 {Duration:9999999,Tags:["system_lobby_mark","system_class_mark"],CustomName:"[\"§f踩上彩色混凝土块切换羊羊类型§r\"]"}
summon minecraft:area_effect_cloud -161 10 -126 {Duration:9999999,Tags:["system_lobby_mark","system_lobby_mark_enter","system_lobby_mark_enter_hint","system_lobby_mark_gaming"],CustomName:"[\"§f踩上这里进入游戏§r\"]"}
...
summon minecraft:falling_block -161 9 -126 {Time:1,DropItem:0,NoGravity:1,Glowing:1,BlockState:{Name:"dark_prismarine"},Tags:["system_lobby_mark","system_lobby_mark_enter_block"]}
...
summon minecraft:area_effect_cloud -164 9 -128 {Duration:9999999,Tags:["system_lobby_mark","system_class_mark","system_class_mark_red"],CustomName:"[\"§c急爆§r\"]"}
...
summon minecraft:area_effect_cloud -173 10 -117 {Duration:9999999,Tags:["system_lobby_mark","system_lobby_mark_join","system_lobby_mark_join_blue","system_lobby_mark_join_yellow"],CustomName:"[\"将小羊丢到这里加入§9青金石部落§r\"]"}
