...
# speical sheep air
scoreboard players set @e[tag=sheep_type_air,scores={s_blow_time=1..7}] s_blow_time 8
# speical sheep fast
...
execute as @e[scores={s_blow_time=5}] at @s run data merge entity @s {CustomName:"[{\"text\":\"???\",\"color\":\"gold\"}]"}
execute as @e[scores={s_blow_time=8}] at @s run data merge entity @s {CustomName:"[{\"text\":\"?????\",\"color\":\"red\"}]"}
execute as @e[scores={s_blow_time=10..}] at @s run function sheep:blow/main