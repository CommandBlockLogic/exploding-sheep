...
# trigger
tag @a[scores={s_launch_type=2..},nbt={Inventory:[{Slot:-106b,tag:{item_num:1}}]}] add sheep_change_1
tag @a[scores={s_launch_type=1},nbt={Inventory:[{Slot:-106b,tag:{item_num:1}}]}] add sheep_change_2
