...
execute as @e[tag=boss1,tag=boss_1_skill_3] at @s run tellraw @p[distance=..16] [{"text":"## ","color":"gray","italic":true},{"text":"你被","color":"white"},{"selector":"@e[tag=boss1]"},{"text":"锁定了，快跑！","color":"white"}]
...
execute if entity @e[tag=boss1] if entity @e[tag=boss_1_summon_3] as @e[tag=boss1] at @s if entity @e[tag=boss_1_summon_3,distance=..1] run tellraw @a[tag=boss_1_skill_3_target] [{"text":"## ","color":"gray","italic":true},{"text":"你被","color":"white"},{"selector":"@e[tag=boss1]"},{"text":"诅咒了！","color":"white"}]
...
execute as @e[type=minecraft:armor_stand,tag=boss_1_summon_3] if score @s boss_1_cool3 >= 召唤物限时 boss_1_cool3 run tellraw @a[tag=boss_1_skill_3_target] [{"text":"## ","color":"gray","italic":true},{"selector":"@e[tag=boss1]"},{"text":"放过了你！","color":"white"}]
