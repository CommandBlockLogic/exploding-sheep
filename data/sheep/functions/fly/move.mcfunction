...
# speical sheep fast
execute as @s[tag=sheep_type_fast,scores={s_flying_time=10..,s_blow_time=0}] at @s positioned ~ ~-1 ~ if entity @a[distance=..3] run scoreboard players set @s s_blow_time 1
