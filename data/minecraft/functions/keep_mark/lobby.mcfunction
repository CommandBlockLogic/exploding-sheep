...
summon minecraft:area_effect_cloud -161 10 -126 {Duration:9999999,Tags:["system_lobby_mark","system_lobby_mark_enter","system_lobby_mark_enter_hint","system_lobby_mark_free"],CustomName:"[\"§f踩上这里进入游戏§r\"]"}
