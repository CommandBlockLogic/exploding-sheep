...
execute at @e[tag=system_class_mark_volleyball] as @a[distance=..0.3] unless score @s s_class matches 1001 unless score @s s_class matches 100..999 run advancement grant @a[advancements={sheep:speical_sheep/root=false}] only sheep:speical_sheep/root
