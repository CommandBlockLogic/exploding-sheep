...
execute if score sys tick matches ..479 run execute as @e[tag=ay] run data modify entity @s ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16701501}}}
...
execute if score sys tick matches 490 run data modify entity @e[tag=a_blue,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:13942683}}}
execute if score sys tick matches 500 run data modify entity @e[tag=a_blue,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:12103366}}}
execute if score sys tick matches 510 run data modify entity @e[tag=a_blue,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:8092346}}}
execute if score sys tick matches 520 run data modify entity @e[tag=a_blue,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:3949738}}}
execute if score sys tick matches 490 run data merge entity @e[tag=a_blue,limit=1] {Pose:{LeftArm:[283f,350f,0f]}}
execute if score sys tick matches 500 run data merge entity @e[tag=a_blue,limit=1] {Pose:{LeftArm:[287f,340f,0f]}}
execute if score sys tick matches 510 run data merge entity @e[tag=a_blue,limit=1] {Pose:{LeftArm:[280f,336f,0f]}}
execute if score sys tick matches 520 run data merge entity @e[tag=a_blue,limit=1] {Pose:{LeftArm:[276f,333f,0f]}}
#16701501
#13942683
#12103366
#8092346
...
execute if score sys tick matches 490 run data modify entity @e[tag=a_red,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16493613}}}
execute if score sys tick matches 500 run data modify entity @e[tag=a_red,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:16351261}}}
execute if score sys tick matches 510 run data modify entity @e[tag=a_red,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:13915937}}}
execute if score sys tick matches 520 run data modify entity @e[tag=a_red,limit=1] ArmorItems[2] merge value {id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:11546150}}}
execute if score sys tick matches 490 run data merge entity @e[tag=a_red,limit=1] {Pose:{RightArm:[270f,0f,0f]}}
execute if score sys tick matches 500 run data merge entity @e[tag=a_red,limit=1] {Pose:{RightArm:[260f,0f,0f]}}
execute if score sys tick matches 510 run data merge entity @e[tag=a_red,limit=1] {Pose:{RightArm:[250f,0f,0f]}}
execute if score sys tick matches 520 run data merge entity @e[tag=a_red,limit=1] {Pose:{RightArm:[240f,0f,0f]}}
